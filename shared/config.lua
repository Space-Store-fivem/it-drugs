...
Config.ZoneUpgrades = {
    ...
    ['cocaine_table'] = {
        ...
        price = 8000,
        type = 'table',
        item = 'cocaine_processing_table', -- Item de inventário correto
     ...
     ['coca'] = {
        ...
        price = 8000,
        type = 'table',
        item = 'coca', -- Item de inventário correto
        model = 'bkr_prop_coke_table01a',
        description = 'coca',
        max = 20,
        icon = 'table'
    ...
    ['security_guard'] = {
        ...
        model = 'g_m_y_ballaorig_01', -- Modelo padrão (pode ser sobrescrito pela gangue)
